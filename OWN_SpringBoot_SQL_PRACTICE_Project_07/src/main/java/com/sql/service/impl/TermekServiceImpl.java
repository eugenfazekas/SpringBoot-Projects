...
public class TermekServiceImpl implements TermekService {
	...
	public List<TermekBonyolultsag> listProductsComplexityWithAutoGeneratedIDs() {
		...
		return termekRepository.listProductsComplexityWithAutoGeneratedIDs();
	}

	@Override
	public List<TermekRendelesek> listProductsWasOrderd_ProductsWasNotOrdered_OrdersWithWrongOrderName() {

		return termekRepository.listProductsWasOrderd_ProductsWasNotOrdered_OrdersWithWrongOrderName();
	}

	@Override
	public List<TermekUtolsoRendeles> findProductsLastOrderdDate() {
		
		return termekRepository.findProductsLastOrderdDate();
	}
